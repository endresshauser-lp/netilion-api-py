...
class Links6(object):
    ...
    def __init__(self, attachments=None, categories=None, assets=None, bill_of_materials=None, events=None, deliveries=None, products=None, instrumentations=None, nodes=None, purchase_orders=None, quotations=None, request_for_quotations=None, _configuration=None):  # noqa: E501
