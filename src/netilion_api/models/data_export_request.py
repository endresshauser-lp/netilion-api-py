...
class DataExportRequest(object):
    ...
    def __init__(self, type=None, start_date=None, end_date=None, language=None, asset=None, instrumentation=None, system=None, batch=None, keys=None, _configuration=None):  # noqa: E501
