...
class AddressBase(object):
    ...
    def __init__(self, street=None, street_number=None, zip_code=None, city=None, region_code=None, country_code=None, phone=None, company_name=None, _configuration=None):  # noqa: E501
    ...
    def zip_code(self, zip_code):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and zip_code is None:
