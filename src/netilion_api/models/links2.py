...
class Links2(object):
    ...
    def __init__(self, documents=None, events=None, nodes=None, instrumentations=None, systems=None, pictures=None, specifications=None, subscriptions=None, api_subscriptions=None, health_conditions=None, _configuration=None):  # noqa: E501
