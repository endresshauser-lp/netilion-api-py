...
class SoftwareResponse(object):
    ...
    def __init__(self, id=None, version_number=None, name=None, description=None, tenant=None, software_type=None, links=None, _configuration=None):  # noqa: E501
    ...
    def software_type(self, software_type):
        ...
        """
        if self._configuration.client_side_validation and software_type is None:
