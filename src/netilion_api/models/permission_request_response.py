...
class PermissionRequestResponse(object):
    ...
    def __init__(self, id=None, status=None, request_message=None, response_message=None, permitable=None, request_user=None, response_user=None, _configuration=None):  # noqa: E501
    ...
    def permitable(self, permitable):
        ...
        :type: Permitable1
        """
        if self._configuration.client_side_validation and permitable is None:
    ...
    def request_user(self, request_user):
        ...
        :type: RequestUser
        """
        if self._configuration.client_side_validation and request_user is None:
