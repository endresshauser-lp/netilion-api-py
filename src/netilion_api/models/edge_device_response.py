...
class EdgeDeviceResponse(object):
    ...
    def __init__(self, id=None, type=None, status=None, software_version=None, technical_user=None, order_user=None, api_subscription=None, api_key=None, tenant=None, usergroup=None, add_on=None, last_seen_at=None, links=None, _configuration=None):  # noqa: E501
