...
class AssetBase(object):
    ...
    def __init__(self, serial_number=None, description=None, production_date=None, last_seen_at=None, _configuration=None):  # noqa: E501
    ...
    def serial_number(self, serial_number):
        ...
        if (self._configuration.client_side_validation and
                serial_number is not None and len(serial_number) > 255):
            raise ValueError("Invalid value for `serial_number`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                serial_number is not None and len(serial_number) < 4):
            raise ValueError("Invalid value for `serial_number`, length must be greater than or equal to `4`")  # noqa: E501
