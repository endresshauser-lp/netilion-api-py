...
class ThresholdResponse(object):
    ...
    def __init__(self, id=None, name=None, description=None, key=None, unit_id=None, value=None, tolerance=None, threshold_type=None, notification=None, _configuration=None):  # noqa: E501
    ...
    def tolerance(self, tolerance):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and tolerance is None:
    ...
    def threshold_type(self, threshold_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and threshold_type is None:
