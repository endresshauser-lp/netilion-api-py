...
class AssetHealthConditionResponse(object):
    ...
    def __init__(self, id=None, asset_status=None, channel=None, module=None, links=None, _configuration=None):  # noqa: E501
