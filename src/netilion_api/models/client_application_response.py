...
class ClientApplicationResponse(object):
    ...
    def __init__(self, id=None, allow_edge_device_application=None, contact_person=None, technical_user=None, billing_contact=None, links=None, _configuration=None):  # noqa: E501
