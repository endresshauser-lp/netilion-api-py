...
class Links12(object):
    ...
    def __init__(self, assets=None, bill_of_materials=None, documents=None, nodes=None, pictures=None, specifications=None, thresholds=None, _configuration=None):  # noqa: E501
