...
class UserResponse(object):
    ...
    def __init__(self, id=None, confirmed_at=None, confirmation_sent_at=None, created_at=None, updated_at=None, disabled=None, address=None, links=None, _configuration=None):  # noqa: E501
