...
class AssetResponse(object):
    ...
    def __init__(self, id=None, ownership_claimed=False, created_at=None, updated_at=None, product=None, product_variant=None, parent=None, status=None, tenant=None, links=None, _configuration=None):  # noqa: E501
