...
class PurchaseOrderBase(object):
    ...
    def __init__(self, number=None, customer_number=None, customer_purchase_order_number=None, name=None, _date=None, description=None, status=None, sender=None, receiver=None, quotation=None, _configuration=None):  # noqa: E501
