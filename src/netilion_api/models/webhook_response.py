...
class WebhookResponse(object):
    ...
    def __init__(self, url=None, event_types=None, properties=None, disabled=False, _configuration=None):  # noqa: E501
    ...
    def event_types(self, event_types):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and event_types is None:
