...
class APISubscriptionResponse(object):
    ...
    def __init__(self, id=None, created_at=None, updated_at=None, user=None, client_application=None, billing_address=None, shipping_address=None, links=None, _configuration=None):  # noqa: E501
