...
class QuotationResponse(object):
    ...
    def __init__(self, id=None, status=None, sender=None, receiver=None, line_items=None, links=None, _configuration=None):  # noqa: E501
