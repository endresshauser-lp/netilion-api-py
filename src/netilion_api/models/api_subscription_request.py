...
class APISubscriptionRequest(object):
    ...
    def __init__(self, user=None, client_application=None, billing_address=None, shipping_address=None, _configuration=None):  # noqa: E501
