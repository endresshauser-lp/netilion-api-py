...
class SoftwareAttachmentResponse(object):
    ...
    def __init__(self, id=None, type=None, file_name=None, fingerprint=None, content_date=None, remarks=None, software=None, download_href=None, _configuration=None):  # noqa: E501
