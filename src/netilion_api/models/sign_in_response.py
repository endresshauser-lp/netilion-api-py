...
class SignInResponse(object):
    ...
    def __init__(self, time=None, application=None, ip=None, browser_name=None, browser_version=None, device_type=None, platform_name=None, platform_version=None, client_application=None, _configuration=None):  # noqa: E501
