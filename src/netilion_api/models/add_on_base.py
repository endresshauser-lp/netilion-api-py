...
class AddOnBase(object):
    ...
    def __init__(self, name=None, external_reference=None, quantity=None, material_number=None, product_code=None, add_on_type=None, _configuration=None):  # noqa: E501
