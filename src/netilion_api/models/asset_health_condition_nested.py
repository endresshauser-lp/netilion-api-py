...
class AssetHealthConditionNested(object):
    ...
    def __init__(self, id=None, diagnosis_code=None, asset_status=None, channel=None, module=None, links=None, _configuration=None):  # noqa: E501
    ...
    def asset_status(self, asset_status):
        ...
        :type: NestedIDHref
        """
        if self._configuration.client_side_validation and asset_status is None:
