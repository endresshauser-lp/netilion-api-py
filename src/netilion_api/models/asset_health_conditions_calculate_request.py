...
class AssetHealthConditionsCalculateRequest(object):
    ...
    def __init__(self, protocol=None, protocol_version=None, diagnosis_message=None, device_ident=None, product_identifier=None, _configuration=None):  # noqa: E501
    ...
    def diagnosis_message(self, diagnosis_message):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and diagnosis_message is None:
