...
class HealthConditionExtended(object):
    ...
    def __init__(self, protocol=None, protocol_version=None, device_ident=None, product_identifier=None, hidden=False, rules=None, _configuration=None):  # noqa: E501
