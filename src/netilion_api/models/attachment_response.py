...
class AttachmentResponse(object):
    ...
    def __init__(self, id=None, type=None, file_name=None, fingerprint=None, content_author=None, content_version=None, content_date=None, content_type=None, remarks=None, document=None, languages=None, download_href=None, created_at=None, updated_at=None, _configuration=None):  # noqa: E501
