...
class SoftwareAttachmentApi(object):
    ...
    def get_software_attachments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_software_attachments`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_software_attachments`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_link_software_attachment(self, id, body, **kwargs):  # noqa: E501
        """Update a software attachment with a link  # noqa: E501

        update an software attachment that has a link  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_link_software_attachment(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_link_software_attachment_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_link_software_attachment_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_link_software_attachment_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update a software attachment with a link  # noqa: E501

        update an software attachment that has a link  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_link_software_attachment_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_software_attachment(self, id, **kwargs):  # noqa: E501
        ...
        :param int software_id: the software id this software attachment belongs to
        :param str content_date: last edit date of the file. Datetime must be in format YYYY-MM-DD or YYYY-MM-DDThh:mm:ss
        :param str remarks: remarks on the software attachment
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def upload_software_attachment(self, file, software_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_software_attachment(file, software_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param file file: the filedata to upload (required)
        :param int software_id: the software id this software attachment belongs to (required)
        :param str content_date: last edit date of the file. Datetime must be in format YYYY-MM-DD or YYYY-MM-DDThh:mm:ss
        :param str remarks: remarks on the software attachment
        :return: SoftwareAttachmentResponse
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_software_attachment_with_http_info(file, software_id, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_software_attachment_with_http_info(file, software_id, **kwargs)  # noqa: E501
            return data

    def upload_software_attachment_with_http_info(self, file, software_id, **kwargs):  # noqa: E501
        """Create and upload a new software attachment  # noqa: E501

        the creation of an software attachment works through a multipart/form-data upload of the file and its filename.  Forbidden content-types are  - application/xhtml+xml - text/html - application/javascript - text/javascript - application/x-shockwave-flash - application/vnd.adobe.flash.movie - video/x-flv - text/php - application/php - application/x-php - application/x-httpd-php  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_software_attachment_with_http_info(file, software_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('software_id' not in params or
                                                       params['software_id'] is None):  # noqa: E501
