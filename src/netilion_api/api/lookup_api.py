...
class LookupApi(object):
    ...
    def eh_extended_order_code_lookup_with_http_info(self, order_code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('order_code' not in params or
                                                       params['order_code'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `order_code` when calling `eh_extended_order_code_lookup`")  # noqa: E501

        if self.api_client.client_side_validation and ('order_code' in params and
                                                       len(params['order_code']) > 18):
            raise ValueError("Invalid value for parameter `order_code` when calling `eh_extended_order_code_lookup`, length must be less than or equal to `18`")  # noqa: E501
        if self.api_client.client_side_validation and ('order_code' in params and
                                                       len(params['order_code']) < 4):
            raise ValueError("Invalid value for parameter `order_code` when calling `eh_extended_order_code_lookup`, length must be greater than or equal to `4`")  # noqa: E501
        collection_formats = {}
    ...
    def eh_product_lookup_with_http_info(self, serial_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('serial_number' in params and
                                                       len(params['serial_number']) > 18):
            raise ValueError("Invalid value for parameter `serial_number` when calling `eh_product_lookup`, length must be less than or equal to `18`")  # noqa: E501
        if self.api_client.client_side_validation and ('serial_number' in params and
                                                       len(params['serial_number']) < 4):
            raise ValueError("Invalid value for parameter `serial_number` when calling `eh_product_lookup`, length must be greater than or equal to `4`")  # noqa: E501
        collection_formats = {}
    ...
    def eh_successor_lookup_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('serial_number' in params and
                                                       len(params['serial_number']) > 18):
            raise ValueError("Invalid value for parameter `serial_number` when calling `eh_successor_lookup`, length must be less than or equal to `18`")  # noqa: E501
        if self.api_client.client_side_validation and ('serial_number' in params and
                                                       len(params['serial_number']) < 4):
            raise ValueError("Invalid value for parameter `serial_number` when calling `eh_successor_lookup`, length must be greater than or equal to `4`")  # noqa: E501
        collection_formats = {}
