...
class EventStatusApi(object):
    ...
    def get_event_statuses_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_event_statuses`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_event_statuses`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_event_status(self, id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_status(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_event_status_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_event_status_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_event_status_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update an event status  # noqa: E501

        Update accessible parameters of the requested resource. Parameters supporting translation: ```name, description```. To add a translation set Content-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_status_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
