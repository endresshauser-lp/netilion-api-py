...
class ProductHealthConditionApi(object):
    ...
    def add_health_conditions_to_product(self, product_id, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_health_conditions_to_product(product_id, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_health_conditions_to_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_health_conditions_to_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
            return data

    def add_health_conditions_to_product_with_http_info(self, product_id, body, **kwargs):  # noqa: E501
        """Add health conditions to an product  # noqa: E501

        Add one or more health conditions to an product.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_health_conditions_to_product_with_http_info(product_id, body, async_req=True)
        >>> result = thread.get()
    ...
    def get_product_health_conditions_with_http_info(self, product_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_product_health_conditions`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_product_health_conditions`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def reaplace_health_conditions_of_product(self, product_id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reaplace_health_conditions_of_product(product_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reaplace_health_conditions_of_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.reaplace_health_conditions_of_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
            return data

    def reaplace_health_conditions_of_product_with_http_info(self, product_id, body, **kwargs):  # noqa: E501
        """Replace health conditions of an product  # noqa: E501

        Replaces all health conditions belonging to an product. You can send a list of resources that will replace all previous values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reaplace_health_conditions_of_product_with_http_info(product_id, body, async_req=True)
        >>> result = thread.get()
    ...
    def remove_health_conditions_of_product(self, product_id, body, **kwargs):  # noqa: E501
        """Remove health conditions of an product  # noqa: E501

        Remove one or more health conditions from an product.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_health_conditions_of_product(product_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_health_conditions_of_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_health_conditions_of_product_with_http_info(product_id, body, **kwargs)  # noqa: E501
            return data

    def remove_health_conditions_of_product_with_http_info(self, product_id, body, **kwargs):  # noqa: E501
        """Remove health conditions of an product  # noqa: E501

        Remove one or more health conditions from an product.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_health_conditions_of_product_with_http_info(product_id, body, async_req=True)
        >>> result = thread.get()
