...
class ValuesApi(object):
    ...
    def get_batch_values_with_http_info(self, batch_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_batch_values`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_batch_values`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_batch_values_for_key_with_http_info(self, batch_id, key, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 1000):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_batch_values_for_key`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_batch_values_for_key`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_system_values_with_http_info(self, system_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_system_values`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_system_values`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_system_values_for_key_with_http_info(self, system_id, key, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 1000):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_system_values_for_key`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_system_values_for_key`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
