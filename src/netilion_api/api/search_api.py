...
class SearchApi(object):
    ...
    def search(self, q, **kwargs):  # noqa: E501
        ...
        search assets, instrumentations and nodes based on a defined set of fields.   asset - serial_number product_code product_name product_manufacturer_name   batches - batch_name      instrumentation - tag   nodes - name   recipes - recipe_name      systems - system_name    These fields may be extended in the  future.  # noqa: E501
    ...
    def search_with_http_info(self, q, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `search`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `search`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
