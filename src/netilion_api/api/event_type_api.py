...
class EventTypeApi(object):
    ...
    def update_event_type(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_type(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_event_type_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_event_type_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_event_type_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update an event type  # noqa: E501

        Update accessible parameters of the requested resource. Parameters supporting translation: ```name, description```. To add a translation set Content-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_type_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
