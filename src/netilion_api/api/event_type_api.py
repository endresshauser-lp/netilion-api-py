...
class EventTypeApi(object):
    ...
    def create_event_type(self, body, **kwargs):  # noqa: E501
        """Create a new event type  # noqa: E501
        ...
        >>> thread = api.create_event_type(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EventTypeRequest body: EventType object to create. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_event_type_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_event_type_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_event_type_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a new event type  # noqa: E501

        Code must be unique. Parameters supporting translation: ```name, description```. POST sets values in default language: en.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_event_type_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_event_type" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `create_event_type`")  # noqa: E501
    ...
    def delete_event_type(self, id, **kwargs):  # noqa: E501
        """Delete an event type  # noqa: E501

        Delete a specific resource identified by the id in the URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_event_type(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id of the event type to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_event_type_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_event_type_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_event_type_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete an event type  # noqa: E501

        Delete a specific resource identified by the id in the URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_event_type_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_event_type" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `delete_event_type`")  # noqa: E501
    ...
    def get_event_type_by_id(self, id, **kwargs):  # noqa: E501
        """Get a single event type  # noqa: E501

        Get a specific event type identified by the id in the URL. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_event_type_by_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id of event type to fetch (required)
        :param str accept_language: The client's accepted languages. One or several (e.g. fr,de,en)
        :return: EventTypeResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_event_type_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_event_type_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_event_type_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a single event type  # noqa: E501

        Get a specific event type identified by the id in the URL. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_event_type_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_event_type_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `get_event_type_by_id`")  # noqa: E501
    ...
    def get_event_types(self, **kwargs):  # noqa: E501
        """Get a range of event types  # noqa: E501

        Returns a list of all event types that are available in your scope. You can apply the query parameters listed below to get a filtered list. Parameters supporting translation: ```name, description```. To get a translation set Accept-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_event_types_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_event_types`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('per_page' in params and params['per_page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `per_page` when calling `get_event_types`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_event_type(self, id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_type(id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Id of the event type to update (required)
        :param EventTypeRequest body: Parameters that shall be updated. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_event_type_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_event_type_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_event_type_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update an event type  # noqa: E501

        Update accessible parameters of the requested resource. Parameters supporting translation: ```name, description```. To add a translation set Content-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_event_type_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `update_event_type`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `update_event_type`")  # noqa: E501
